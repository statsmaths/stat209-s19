...
There are three primary ways to get help with the course:

\begin{itemize}
\item \textbf{lab form}: Ask you question as part of the lab form. This is
particularly useful if you a general misunderstanding about a concept or a
very specific question about one of the lab questions.
\item \textbf{piazza}: I have created an Piazza site for our course; there is
...
If you have any personal issues, please also feel free to email me directly.
For questions about the course material, however, I will direct you to instead
make a Piazza post so that everyone can benefit from the answer.
